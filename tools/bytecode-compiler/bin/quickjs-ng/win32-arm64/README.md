# Placeholder — quickjs-ng compiler for host `win32-arm64`

Expected binary: `nsbc-quickjs-ng.exe`

Produced by `.github/workflows/bytecode-compilers.yml` (artifact
`bytecode-compiler-quickjs-ng-win32-arm64`). Drop the built binary here, keeping this name.
