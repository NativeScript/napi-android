# Placeholder — quickjs compiler for host `win32-arm64`

Expected binary: `nsbc-quickjs.exe`

Produced by `.github/workflows/bytecode-compilers.yml` (artifact
`bytecode-compiler-quickjs-win32-arm64`). Drop the built binary here, keeping this name.
