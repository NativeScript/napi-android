# Placeholder — quickjs compiler for host `darwin-arm64`

Expected binary: `nsbc-quickjs`

Produced by `.github/workflows/bytecode-compilers.yml` (artifact
`bytecode-compiler-quickjs-darwin-arm64`). Drop the built binary here, keeping this name.
